...
function resolveRef(doc, raw) {
  ...
  const named = { top: 'top', 顶层: 'top', 梗概: 'synopsis', synopsis: 'synopsis', 停车场: 'parking', parking: 'parking', 泳道: 'lanes', lanes: 'lanes', 全文: 'all', all: 'all', 玩法: 'mechs', mechanics: 'mechs', 地图: 'maps', maps: 'maps' };
